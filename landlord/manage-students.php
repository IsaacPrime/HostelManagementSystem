...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Manage Hostellers</h2>
						<div class="panel panel-default">
							<div class="panel-heading">All Hosteller's Details</div>
							<div class="panel-body">
							<form class="form-horizontal" action="manage-students.php" method="POST">
  ...
  <button type="submit" name="submit" class="btn btn-primary">Request Hostellers Registered Under Your ID</button>
</form>
