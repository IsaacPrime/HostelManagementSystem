...
$stmt=$mysqli->prepare("SELECT username,email,password,id FROM landlord WHERE (userName=?|| email=?) and password=? ");
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									<label for="" class="text-uppercase text-sm">Landlord Username or Email</label>
									<input type="text" placeholder="Username" name="username" class="form-control mb">
									<label for="" class="text-uppercase text-sm">ID Number</label>
