						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Fill Your iSsue below</div>
		...
		<div class="container-contact1">
			...
			<form class="contact1-form validate-form" action="https://formspree.io/f/xwkyrgzd" method="POST" id="contact">
				...
				<div class="wrap-input1 validate-input" data-validate = "Phone is required">
					<input class="input1" type="text" id="phone" name="subject" placeholder="Phone Number">
					<span class="shadow-input1"></span>
				</div>
...
<script>
  ...
  gtag('config', 'UA-23581568-13');
	...
	<script>var form = document.getElementById("contact");
