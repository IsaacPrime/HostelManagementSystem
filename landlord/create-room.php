...
$rc=$stmt->bind_param('ssssssssssss',$seater, $room_no,$pproom,$roomtype, $fees,$landlordphone,$landlordname,$hostelid,$upload_image,$hostellocation,$proximity,$amenities);
$stmt->execute();
