...
$query="insert into  registration(roomno,hostel_id,seater,personproom,roomtype,feespm,landlordphone,landlordname,stayfrom,stayto,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('siiississssssssssisississsisssi',$roomno,$hostel_id,$seater,$personproom,$roomtype,$feespm,$landlordphone,$landlordname,$stayto,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
echo"<script>alert('Hostel Booked Succssfully');</script>";
}
?>
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
					<br>
						<h2 class="page-title">Hostel Booking </h2>
...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: green" align="left"> You already booked an hostel</h3>
				<?php }
				else{
							echo "";
							}			
...
<div class="col-sm-8">
<select name="roomno" id="roomno"class="form-control"  onChange="getSeater(this.value);" onBlur="checkAvailability()" required> 
...
<div class="form-group">
<label class="col-sm-2 control-label">Hostel Number</label>
<div class="col-sm-8">
...
<div class="col-sm-8">
<input type="text" name="pproom" id="pproom"  class="form-control"  >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="rtype" id="rtype"  class="form-control"  >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="lphone" id="lphone"  class="form-control" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="lndname" id="lndname"  class="form-control" >
</div>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Stay To</label>
<div class="col-sm-8">
<input type="date" name="stayt" id="stayt"  class="form-control" >
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Duration in Months</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" align="left">Home Address </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-3 control-label"><h4 style="color: green" align="left">School address </h4> </label>
</div>
